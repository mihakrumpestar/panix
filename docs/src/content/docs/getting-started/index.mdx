...
- SSH key authentication to target machine(s) (password auth is not supported)
...
:::note
Some distibutions live ISOs may be missing packages needed to start kexec. NixOS installer and most mainstream distros should work out of the box.
:::
