...
- **Phase-oriented execution**: Six sequential deployment phases: Inspect, Bootstrap, Build, Transfer, Secrets, and Activate execute with defined scopes. The Build phase runs once per installable, deduplicating work across machines sharing the same installable.
