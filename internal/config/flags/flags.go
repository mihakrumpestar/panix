...
type WorkflowFlags struct {
	...
	DisableDisko         bool                      `yaml:"disable_disko" json:"disable_disko,omitempty" help:"Disables building, transfer and execution of disko tool when bootstrapping"`
	...
	ActivationMode       attributes.ActivationMode `yaml:"activation_mode" json:"activation_mode" help:"Activation mode: check, switch, boot, test, dry-activate" default:"switch" validate:"omitempty,oneof=check switch boot test dry-activate"` //nolint:lll
...
type Logging struct {
	Log        bool   `yaml:"log" json:"log" short:"l" help:"Enable logging to file"`
	LogFile    string `yaml:"log_file" json:"log_file" help:"Log file path (epoch timestamp appended before .log)" default:"panix.log"`
	Debug      bool   `yaml:"debug" json:"debug" short:"d" help:"Debug output (enables logging)"`
	CPUProfile string `yaml:"cpu_profile" json:"cpu_profile" help:"Path for cpu profiling to file, declaring it enables it"`
}
