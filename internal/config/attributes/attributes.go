...
type Bootstrap struct {
	...
	Kexec                         *KexecConfig                `yaml:"kexec" json:"kexec,omitempty" desc:"Kexec configuration for bootstrapping non-NixOS machines or reinstalling a live NixOS installation"`
