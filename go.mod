...
require (
	charm.land/bubbles/v2 v2.1.1 // only for benchmarks
	charm.land/lipgloss/v2 v2.0.5 // only for benchmarks
	...
	github.com/gdamore/tcell/v3 v3.4.1 // only for benchmarks
