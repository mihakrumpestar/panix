...
require (
	charm.land/bubbles/v2 v2.1.0 // only for benchmarks
	charm.land/lipgloss/v2 v2.0.4 // only for benchmarks
	...
	github.com/charmbracelet/ultraviolet v0.0.0-20260608091853-35bcb7319efa // only for benchmarks
